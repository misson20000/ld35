...
export class WinState {
  ...
  render() {
    this.fnt.draw(this.batch, -300, -120, "You win :)", 1, 1, 1);
    this.fnt.draw(this.batch, -300, -50, "Thank you for presisting");
    this.fnt.draw(this.batch, -300, 0, "through to the end!", 1, 1, 1);
    this.batch.flush();
  }
}
